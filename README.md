...
This repository contains the conceptual definition and theoretical framework for **Spiritual Order**, 
...
├── LICENSE             # CC BY 4.0
├── paper/
│   └── spiritual-order.tex    # LaTeX dissertation
├── whitepaper/
│   └── spiritual-order.md     # White paper
└── translations/
    ├── de/             # German
    ├── en/             # English
    ├── tr/             # Turkish
...
```bibtex
@misc{vega2025spiritualorder,
  author = {Vega, Adam Eren},
  title = {Spiritual Order: A Conceptual Framework},
  year = {2025},
  publisher = {GitHub},
  url = {https://github.com/vegafoundation/spiritual-order}
}
```
